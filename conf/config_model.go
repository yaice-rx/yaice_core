...
//联盟
type AllianceGiftLvModel struct {
	ID         int
	BigGiftPro string
	Exp        int
}
...
//联盟成员等级
type AllianceRankModel struct {
	ID  int
	Num int
}

//地图信息
type TempAreaModel struct {
	ID             int
...
//军械
type TempArmamentsModel struct {
	ID        int
	Type      int
	Level     int
	Atk       int
