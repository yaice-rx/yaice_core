...
type S2C_UserLogin struct {
	Code                 E_LoginCode `protobuf:"varint,1,opt,name=code,proto3,enum=internal_proto.E_LoginCode" json:"code,omitempty"`
...
func init() {
	...
	proto.RegisterType((*C2S_UserLogin)(nil), "internal_proto.C2S_UserLogin")
	proto.RegisterType((*S2C_UserLogin)(nil), "internal_proto.S2C_UserLogin")
}
